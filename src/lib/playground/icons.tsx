...
const TEMPLATE_ICONS: Record<string, IconSpec> = {
  ...
  flutter:         { Cmp: SiFlutter,        color: "#02569B" },
  android:         { Cmp: SiAndroid,        color: "#3DDC84" },
  scala:           { Cmp: SiScala,          color: "#DC322F" },
  objc:            { Cmp: SiApple,          color: "#A8B9CC" },
  sqlite:          { Cmp: SiSqlite,         color: "#003B57" },
  mysql:           { Cmp: SiMysql,          color: "#4479A1" },
  postgres:        { Cmp: SiPostgresql,     color: "#4169E1" },
  mongodb:         { Cmp: SiMongodb,        color: "#47A248" },
  mariadb:         { Cmp: SiMariadb,        color: "#003545" },
  express:         { Cmp: SiExpress,        color: "#cbd5e1" },
  flask:           { Cmp: SiFlask,          color: "#cbd5e1" },
  fastapi:         { Cmp: SiFastapi,        color: "#009688" },
  spring:          { Cmp: SiSpring,         color: "#6DB33F" },
  dotnet:          { Cmp: SiDotnet,         color: "#512BD4" },
  nextjs:          { Cmp: SiNextdotjs,      color: "#cbd5e1" },
  react:           { Cmp: SiReact,          color: "#61DAFB" },
  api:             { Cmp: Globe,            color: "#7eb2ff" },
  database:        { Cmp: Database,         color: "#7eb2ff" },
};
